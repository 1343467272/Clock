...
public class PreferencesKeys {
    ...
    public static final String KEY_LAN_SYNC_SETTINGS = "key_lan_sync_settings";
    public static final String KEY_LAN_SYNC_NOW = "key_lan_sync_now";
    ...
    public static final String KEY_ALARM_NOTIFICATION_REMINDER = "key_alarm_notification_reminder";
    ...
    public static final String KEY_DISPLAY_ALARM_TITLE_ON_SINGLE_LINE = "key_display_alarm_title_on_single_line";
    ...
    public static final String KEY_ENABLE_PER_TIMER_VIBRATION_PATTERN = "key_enable_per_timer_vibration_pattern";
    ...
    public static final String KEY_SCREENSAVER_BATTERY_COLOR_PICKER = "key_screensaver_battery_color_picker";
    ...
    public static final String KEY_SCREENSAVER_BATTERY_IN_ITALIC = "key_screensaver_battery_in_italic";
    ...
    public static final String KEY_DIGITAL_WIDGET_DEFAULT_CITY_NOTE_COLOR = "key_digital_widget_default_city_note_color";
